 ...
 */
export function decoderError(
  fatal: boolean,
  opt_code_point: number | undefined = undefined
): number {
 ...
 */
export function encoderError(code_point: number): number {
...
export function getEncoding(
  label: string
): { name: string; labels: Array<string> } | null {
...
const encodings: {
  heading: string;
  encodings: { name: string; labels: string[] }[];
}[] = [
  {
    encodings: [
      {
